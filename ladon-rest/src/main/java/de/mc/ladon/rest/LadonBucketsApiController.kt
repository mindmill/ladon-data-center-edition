...
open class LadonBucketsApiController(
    ...
    override fun createBucket(
            ...
            @Valid @RequestBody body: Bucket?): ResponseEntity<Bucket>? { // do some magic!
    ...
    override fun deleteBucket(
            @ApiParam(value = "", required = true)
            @PathVariable("bucket") bucket: String): ResponseEntity<ResponseSuccess?>? { // do some magic!
        return ResponseEntity(HttpStatus.OK)
    }
    ...
    override fun getBucket(
            @ApiParam(value = "", required = true)
            @PathVariable("bucket") bucket: String): ResponseEntity<Bucket?>? { // do some magic!
        return ResponseEntity(HttpStatus.OK)
    }
    ...
    override fun listBuckets(
            ...
            page: Long?): ResponseEntity<List<Bucket>>? { // do some magic!
        return ResponseEntity(HttpStatus.OK)
    }
