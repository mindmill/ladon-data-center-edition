 ...
 */
public class LadonCmisService extends AbstractCmisService implements CallContextAwareCmisService {

    private final LadonCmisRepositoryManager repositoryManager;
    private CallContext context;

    public LadonCmisService(final LadonCmisRepositoryManager repositoryManager) {
     ...
     */
    public LadonCmisRepository getRepository() {
    ...
    public RepositoryInfo getRepositoryInfo(String repositoryId, ExtensionsData extension) {
        for (LadonCmisRepository fsr : repositoryManager.getRepositories()) {
