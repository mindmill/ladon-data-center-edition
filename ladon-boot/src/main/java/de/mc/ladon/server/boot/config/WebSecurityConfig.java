...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/ladon/feed/**")
                .permitAll()
                .antMatchers("/")
                .permitAll()
                .antMatchers("/ladon/assets/**")
                .permitAll()
                .antMatchers("/ladon/cassandra/init")
                .permitAll()
                .antMatchers("/ladon/health")
                .permitAll()
                .antMatchers("/ladon/metrics")
                .permitAll()
                .antMatchers("/services/**")
                .permitAll()
                .antMatchers("/ladon/**").hasRole("admin")
                .antMatchers("/ladon/api/rest/**").hasRole("user")
                .anyRequest()
                .authenticated()
                .and()
                .httpBasic()
                .and()
                .formLogin()
                .loginPage("/ladon/login")
                .defaultSuccessUrl("/ladon/overview")
                .permitAll()
                .and()
                .logout()
                .logoutUrl("/ladon/logout")
